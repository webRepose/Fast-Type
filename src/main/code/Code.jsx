...
import Style from "../../styles/Main/Text/Text.module.scss";
...
const Code = () => {
  ...
  const parse = JSON.parse(localStorage.getItem("code")),
    ...
    mobMenu =
      keyboardBool || plBool || timeBool || modeBool || wordsBool
        ? Style.grid
        : "";

  const LangNames = ["JavaScript", "CSS", "HTML"];
  ...
  const sectionChoice = [
    {
      img: "./img/code/terminal.svg",
      alt: "PL",
      name: "C-LP",
      buttonTitle: "Ctitle-plang",
      func: langProgFunc,
      text: parse.codeProgLang,
    },
    {
