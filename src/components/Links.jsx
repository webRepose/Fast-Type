...
const Links = memo(() => {
    return (
        ...
        <Route path='text/typing' element={<Suspense fallback={<Preloader/>}><Type/></Suspense>}></Route>
        <Route path='code/typing' element={<Suspense fallback={<Preloader/>}><TypingCode/></Suspense>}></Route>
        <Route path='symbols/typing' element={<Suspense fallback={<Preloader/>}><TypingSymbols/></Suspense>}></Route>
