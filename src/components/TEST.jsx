    ...
    return (
        <main>
            <Section>
                ...
                <RainbowButton onClick={()=>{request('http://server.kz/', setHandText)}}>
                    Get date
                </RainbowButton>
                ...
                <div style={{marginBottom:'20px'}}>
                    ...
                    <form action="http://send.kz/" method="POST">
                        <input required pattern="[/[0-9]/]" id="num1" name='num1' type="number" />
                        <br/>
                        <br/>
                        <input required pattern="[/[0-9]/]" id="num2" name='num2' type="number" />
                        <br/>
                        <input onClick={(e)=>{
                            // e.preventDefault()
                    ...
                    <button onClick={()=>{request2('http://send.kz/', setHandText2)}}></button>
